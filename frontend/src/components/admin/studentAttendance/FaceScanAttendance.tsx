...
import { markAttendanceViaFaceApiCall } from '@/src/store/slices/attandance/studanceAttendanceSlice';
...
export default function FaceScanAttendancePage() {
  ...
  const handleFaceAttendance = async () => {
    ...
    try {
      ...
      const data = await markAttendanceViaFaceApiCall(token, faceDescriptor);
